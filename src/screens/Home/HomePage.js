      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.profileContainer}>
          ...
          <View style={styles.tabButtonsContainer}>
            ...
            {/* {TabButton(currentTab, setCurrentTab, 'Logout', logoutIcon, () => handleTabPress('WelcomeScreen'))} */}
            {TabButton(currentTab, setCurrentTab, 'Logout', logoutIcon, () => handleTabPress('Logout'))}
        ...
        >
          ...
          <ScrollView contentContainerStyle={styles.scrollViewContent}>
                ...
                <View style={{ alignSelf: 'center', flexDirection: 'row' }}>
                  <View style={styles.starImage}>
                    <Image
                      ...
                      style={cStyles.staricon}
                    />
                  </View>
                  <Text style={[styles.text, { alignSelf: 'center', left: 2 }]}>4.0</Text>
                </View>
              </View>
            ...
            <View style={styles.content}>
              <Text style={[cStyles.headerText0BL, { marginBottom: 10, left: 4 }]}>Your Earnings</Text>
              <View style={styles.card1}>
                <View style={styles.earning}>
                  <Text style={[cStyles.TodayEarningtext, { marginBottom: 4 }]}>Today’s Earning</Text>
                  <Text style={cStyles.headerText2Gr}>₹320.00</Text>
                </View>
                <View style={styles.verticalLine} />
                <View style={styles.earning}>
                  <Text style={[cStyles.headerText2G, { marginBottom: 4 }]}>Monthly Earning</Text>
                  <Text style={cStyles.priceText}>₹1,220.00</Text>
                </View>
              </View>
            </View>
            <View style={styles.content}>
              <Text style={[cStyles.headerText0BL, { marginBottom: 10, left: 4 }]}>Currently Delivering</Text>
              <TouchableOpacity onPress={() => navigation.navigate('Deliveries')}>
                <View style={styles.card2}>
                  <View style={[styles.leftContainer, { justifyContent: 'space-between' },]}>
                    ...
                    <Text style={[cStyles.headerText2G, { left: 3 }]}>₹1,939.00</Text>
                  </View>
                  <View style={[styles.leftContainer, { justifyContent: 'space-between', marginTop: 10 },]}>
                    <View style={styles.leftContainer}>
                      ...
                      <View style={styles.textContainer}>
                        <Text style={[cStyles.cardText, { marginBottom: 0,top:2 }]}>The Glenlivet 12 Year Old</Text>
                        <Text style={[cStyles.cardText, { color: '#DF1F26', marginVertical: 4, bottom: 4 }]}>+ 4 Items</Text>
                        <Text style={[cStyles.TimeText, styles.numberText]}>
                          10:00 AM - 11:00 AM
                        </Text>
                      </View>
            ...
            <View style={styles.content}>
              <Text style={[cStyles.headerText0BL, { marginBottom: 10, left: 4 }]}>Pending Orders <Text style={cStyles.headerText2G}>(3)</Text></Text>
              <View style={styles.card2}>
                <View style={[styles.leftContainer, { justifyContent: 'space-between', },]}>
                  <Text style={[cStyles.headerText0BL]}>#UNTD2405135</Text>
                  <Text style={[cStyles.headerText2G, { left: 3 }]}>₹1,569.00</Text>
                </View>
                <View style={[styles.leftContainer, { justifyContent: 'space-between', marginTop: 10 },]}>
                  <View style={styles.leftContainer}>
                    <View style={styles.imageL}>
                    ...
                    <View style={styles.textContainer}>
                      ...
                      <Text style={[cStyles.cardText, { color: '#DF1F26', marginVertical: 3, bottom: 4 }]}>+ 1 Items</Text>
                      <Text style={[cStyles.TimeText, styles.numberText]}>
                        12:00 AM - 01:00 PM
                      </Text>
                    </View>
